...
class CompteAdmiadministrateurs
{
    ...
    public static function mise_a_jour_image_de_profil()
    {
        ...
        try {
            $req_0 = "select image_de_profil from administrateurs where id='" . $_SESSION['compte']['id'] . "'";
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 85%;"><?php echo $data['nom'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Prénom : </th>
                    <td style="width: 85%;"><?php echo $data['prenom'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Rôle : </th>
                    <td style="width: 85%;"><?php echo $data['role'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Email : </th>
                    <td style="width: 85%;"><?php echo $data['email'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Téléphone : </th>
                    <td style="width: 85%;"><?php echo $data['telephone'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">DOB : </th>
                    <td style="width: 85%;"><?php echo $data['date_de_naissance'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Genre : </th>
                    <td style="width: 85%;"><?php echo $data['genre'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Ville : </th>
                    <td style="width: 85%;"><?php echo $data['ville'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">Adresse : </th>
                    <td style="width: 85%;"><?php echo $data['adresse'] ?></td>
                </tr>
                <tr>
                    <th class="w-auto">DOR : </th>
                    <td style="width: 85%;"><?php echo $data['date_de_linscription'] ?></td>
                </tr>
                <tr>
