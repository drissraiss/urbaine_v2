                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <img class="img-account-profile rounded-circle mb-2 border border-2" src="../data/profiles/<?= $_SESSION['compte']['image_de_profil'] ?? 'profil.jpeg' ?>" alt="profil" id="profil-img__">
