                        ...
                        <table class="table table-hover bg-white">
                            ...
                            <tbody>
                                ...
                                while ($demande = mysqli_fetch_assoc($result)) {
                                    echo "<tr class='demande-employee-short align-middle' id-demande='" . $demande['id'] . "'>";
                                    echo "<td>" . $demande['id'] . "</td>";
                                    echo "<td>" . $demande['titre'] . "</td>";
                                    echo "<td>" . $demande['envoyeur'] . "</td>";
                                    //echo "<td>" . $demande['date'] . "</td>";
                                    echo "<td>" . date('Y-m-d h:i A', strtotime( $demande['date'])) . "</td>";
                        ...
                        <table class="table table-hover bg-white">
                            ...
                            <tbody>
                                ...
                                while ($plainte = mysqli_fetch_assoc($result)) {
                                    echo "<tr class='plainte-employee-short align-middle' id-plainte='" . $plainte['id'] . "'>";
                                    echo "<td>" . $plainte['id'] . "</td>";
                                    echo "<td>" . $plainte['titre'] . "</td>";
                                    echo "<td>" . $plainte['envoyeur'] . "</td>";
                                    echo "<td>" . date('Y-m-d h:i A', strtotime( $plainte['date'])) . "</td>";
                                    echo "<td>";
                                ?>
